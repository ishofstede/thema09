...
# Research Question 
Can a machine learning model accurately classify birds into ecological grouops based on their bone measurements, and if so, which bone measurements are most informative for classification. 
