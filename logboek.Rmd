...
ggplot(bird_data, aes(x = huml, y = type)) + geom_boxplot() + labs(title = "huml length in mm", x = "(mm of bone)", y = "type")
#boxplot of humw width 
ggplot(bird_data, aes(x = humw, y = type)) + geom_boxplot() + labs(title = "humw length in mm", x = "(mm of bone)", y = "type")

#boxplot of ulnal length
ggplot(bird_data, aes(x = ulnal, y = type)) + geom_boxplot() + labs(title = "ulnal length in mm", x = "(mm of bone)", y = "type")
#boxplot of ulnaw width
ggplot(bird_data, aes(x = ulnaw, y = type)) + geom_boxplot() + labs(title = "ulnaw length in mm", x = "(mm of bone)", y = "type")

#boxplot of feml length
ggplot(bird_data, aes(x = ulnal, y = type)) + geom_boxplot() + labs(title = "feml length in mm", x = "(mm of bone)", y = "type")
#boxplot of femw width
ggplot(bird_data, aes(x = ulnaw, y = type)) + geom_boxplot() + labs(title = "femw length in mm", x = "(mm of bone)", y = "type")
...
ggplot(bird_data, aes(x = tarl, y = type)) + geom_boxplot() + labs(title = "ulnal length in mm", x = "(mm of bone)", y = "type")
#boxplot of tarw width
ggplot(bird_data, aes(x = tarw, y = type)) + geom_boxplot() + labs(title = "ulnaw length in mm", x = "(mm of bone)", y = "type")
```
...
Revised: Using machine learning algorithms, which bone emasurement are msot informative for classifying birds into ecological groups?