...
The results show that simpleLogistic and RandomForest come out on top again. The KNN algorithm has significant decreased performance. J48 tree also has a decrease after adjustment. SMO has remained the same. The two algorithms that will be used for further analysis are KNN, simpleLogic and RandomForest.
...
Using the experimenter we determined that KNN was not overfitted. Thus this is the model that shall be used 
...
Overall it seems the length and width of the humerus and ulna are the most significant measurements for accurate classification of bird groups. These bones are located in the wings of the bird. It makes sense that wingspan would determine the group that the bird belongs to. Lagging behind in ranking are the femur and tibiotarsus bones, which are located in the legs of the bird. The humerus and ulna values will therefor be used for further analysis. 

## ROC curve 
To find the ROC curve we load our dataset into Wekka and go to the explorer, there we can go into the classify menu and use Logistic classifier and visualise the threshold curve. We do this for every attribute. Pictured below are the values for the RandomForest algorithm


Correctly Classified Instances         351               84.9879 %
Incorrectly Classified Instances        62               15.0121 %
Kappa statistic                          0.8061
Mean absolute error                      0.1015
Root mean squared error                  0.2051
Relative absolute error                 38.9129 %
Root relative squared error             56.8004 %
Total Number of Instances              413     

=== Detailed Accuracy By Class ===

                 TP Rate  FP Rate  Precision  Recall   F-Measure  MCC      ROC Area  PRC Area  Class
                 0,888    0,077    0,817      0,888    0,851      0,791    0,967     0,935     SW
                 0,547    0,011    0,897      0,547    0,680      0,663    0,949     0,809     W
                 0,609    0,008    0,824      0,609    0,700      0,694    0,943     0,762     T
                 0,917    0,030    0,800      0,917    0,854      0,836    0,989     0,909     R
                 0,842    0,021    0,800      0,842    0,821      0,802    0,953     0,837     P
                 0,992    0,045    0,904      0,992    0,946      0,924    0,992     0,982     SO
Weighted Avg.    0,850    0,043    0,853      0,850    0,842      0,812    0,972     0,908     
...
(screenshotje toevoegen curve TP en FP rate)
