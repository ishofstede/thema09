...
The results show that simpleLogistic and RandomForest come out on top again. The KNN algorithm has significant decreased performance. J48 tree also has a decrease after adjustment. SMO has remained the same. The two algorithms that will be used for further analysis are simpleLogic and RandomForest.
